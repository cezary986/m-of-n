...
//	@Override
//	protected ConditionBase induceCondition(Rule rule, ExampleSet dataset, Set<Integer> uncovered, Set<Integer> covered, Set<Attribute> allowedAttributes, Object... extraParams) {
//		ConditionBase cond = super.induceCondition(rule, dataset, uncovered, covered, allowedAttributes, extraParams);
//		return  cond;
//	}
