        ...
        for (NominalAttributeConditionKey nominalAttributeConditionKey : allowedNominalAttributesConditions) {
            ...
            Future future = pool.submit(() -> {
                ...
                ConditionEvaluation newBest = RegressionConditionEvaluator.checkCandidate(
                        trainSet, rule, candidateCondition, uncoveredPositives, bestNominalAttributesCondition, params
                );
                if (newBest != null) {
                    Logger.log("\tCurrent best: " + candidateCondition + " (quality=" + newBest.quality + "\n", Level.FINEST);
                    bestNominalAttributesCondition.quality = newBest.quality;
                    bestNominalAttributesCondition.covered = newBest.covered;
