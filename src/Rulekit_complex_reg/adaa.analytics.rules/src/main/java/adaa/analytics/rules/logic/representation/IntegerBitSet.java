...
public class IntegerBitSet implements Set<Integer> {
	...
	/**
	 * Gets the interesection of this set and another one.
	 * @param other Other set.
	 * @return Interesection of sets.
	 */
	public IntegerBitSet getIntersection(IntegerBitSet other) {
		IntegerBitSet out = new IntegerBitSet(this.maxElement);
	...
	/**
	 * Gets the sum of this set and another one.
	 * @param other Other set.
	 * @return Sum of sets.
	 */
	public IntegerBitSet getSum(IntegerBitSet other) {
		IntegerBitSet out = new IntegerBitSet(this.maxElement);
		for (int i = 0; i < this.words.length; ++i) {
		}
		return out;
	...
	public IntegerBitSet merge(IntegerBitSet set) {
		this.addAll(set);
		return this;
	}
}