...
public class SingletonSet implements IValueSet, Serializable {
	...
	/** Value set used for negation, contains all values other than value
	 * if value set is negated or contains only value if not negated **/
	protected Set<Double> valueSet;
	...
	/** Gets {@link #valueSet} */
	public Set<Double> getNegationValues() { return valueSet; }
	/** Gets {@link #value} */
