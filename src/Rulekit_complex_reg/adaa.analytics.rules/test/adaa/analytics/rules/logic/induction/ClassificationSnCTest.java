...
public class ClassificationSnCTest {
    ...
    public void runTestCase(@FromDataPoints("Test cases") TestCase testCase) throws OperatorException, OperatorCreationException, IOException {
        ...
        params.setAttributesIntervalsEnabled(true);
        params.setAttributesConditionsEnabled(true);
        params.setDiscreteAttributesConditionsEnabled(true);
        params.setDiscreteSetConditionsEnabled(true);
        params.setNegatedConditionsEnabled(true);
...
//        RuleSetComparator.assertRulesAreEqual(testCase.getReferenceReport().getRules(), ruleSet.getRules());
        ...
        Assert.assertEquals(testCase.getReferenceReport().getFileContent(), stringBuilder.toString());
    }
}