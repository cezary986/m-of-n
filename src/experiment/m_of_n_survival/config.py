...
from utils.rulekit.operator import DEFAULT_PARAMS_VALUE
...
VERSION: str = '5.0.3__min_supp_20'

ALLOW_COMPLEX_CONDITIONS_IN_M_OF_N: bool = False

DATASET_BASE_PATH: str = f'{dir_path}/../../../datasets/survival'
...
def get_rulekit_params(complex_condition_enabled: bool) -> dict:
    params = DEFAULT_PARAMS_VALUE.copy()
    params.update(**{
