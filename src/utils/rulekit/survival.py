...
class SurvivalRules(BaseOperator):
    ...
    def set_params(
        ...
        if 'survival_time_attr' in kwargs:
    ...
    def fit(self, values: Data, labels: Data, survival_time: Data = None, attributes_mappings: dict[str, List[str]] = None) -> Any:
        ...
        super().fit(values, labels, survival_time_attribute, attributes_mappings=attributes_mappings)
        return self
